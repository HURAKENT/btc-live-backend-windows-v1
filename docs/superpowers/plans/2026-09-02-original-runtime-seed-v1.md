...
- [ ] **Step 1: Add a failing deterministic packaging test**
...
- [ ] **Step 3: Implement and run the packager**
...
- [ ] **Step 4: Pin the resulting manifest and run GREEN**
...
- [ ] **Step 1: Write failing integration/idempotency/conflict tests**
...
- [ ] **Step 3: Implement shared persistence and explicit old path**
...
- [ ] **Step 1: Write a failing parity receipt test**
...
- [ ] **Step 4: Run GREEN and standalone oracle**
...
- [ ] **Step 1: Document the runtime/research split**
...
- [ ] **Step 2: Verify unchanged protected identities**
...
- [ ] **Step 3: Run required suites/checks**
...
- [ ] **Step 5: Commit locally and re-verify isolation**
